				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text" name="name" value="${cookie.username.value}" maxlength="20"/>
							</td>
					  </tr>
					  <tr>
							<th>
							...
							<td>
								<input type="password" name="password" value="xxx" maxlength="20" autocomplete="off"/>
							</td>
					  </tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="http://localhost:8899/cmfz-admin/admin/getVcode" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
